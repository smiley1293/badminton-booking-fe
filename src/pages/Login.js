...
import { getProfileApi, loginApi } from "../services/UserApi";
    ...
    <section className="">
      <div className="flex items-center py-8 md:h-screen lg:py-0">
        <div className="w-[50%] h-[100vh] object-cover flex-shrink">
          <img
            className="object-cover w-full h-full flex-shrink"
            src={login_img}
            alt=""
          />
        </div>
        <div className="w-[50%] flex justify-center">
          <div className="p-6">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <button
                type="button"
                className={`w-full text-[#F4F1E4] bg-[#F8939C] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-[50px] text-[19px] px-5 py-[15px] text-center dark:bg-primary-600 dark:focus:ring-primary-800 mb-[20px]  transition-all ease-in-out ${
                  isValid
                    ? "dark:hover:bg-[#000000] hover:cursor-pointer"
              ...
              <p className=" text-sm text-center font-light text-[#3D4449] dark:text-gray-400">
                Don't have account?{" "}
                <Link
                  className="font-medium text-primary-600 hover:underline dark:text-primary-500 cursor-not-allowed"
                  to={"/Register"}
                >
                  Sign Up
                </Link>
