            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div>
                ...
                >
                  ...
                  <option value={3}>Club owner</option>
                </select>
              </div>

              <button type='button' className="login_btn w-full text-[#F4F1E4] bg-[#000000] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-[50px] text-[19px] px-5 py-[15px] text-center dark:bg-primary-600 dark:hover:bg-[#DF6951] dark:focus:ring-primary-800 mb-[20px] transition-all">Create Account</button>
